 ...
 *
 *  SiriusRTOS
 *  AR_API.h - Architecture API (AT91SAM7S64 Port)
 *  Version 1.00
 *
...
/* Default Real-time Timer Prescaler value (configured for 1 ms interval) */
#ifndef AR_AT91SAM7S_RTTC_RTPRES
  #define AR_AT91SAM7S_RTTC_RTPRES      32
#endif

/* Default Interval Value (PIV) for Periodic Interval Timer */
#ifndef AR_AT91SAM7S_PITC_PIV
  #define AR_AT91SAM7S_PITC_PIV         300
#endif
